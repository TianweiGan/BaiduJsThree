...
export function getMapvThreeMvtPath(url: any, path: any): any;
...
export function normalizeSourceUrl(url: any, token: any, tokenParam: string | undefined, styleUrl: any): string;
