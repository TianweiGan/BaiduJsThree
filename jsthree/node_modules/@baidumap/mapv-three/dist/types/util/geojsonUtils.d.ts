 ...
 */
export function getGeoFeatures(data: any, projection: any): any;
/**
 * 投影坐标递归函数
 * @internal
 ...
 * @param {string} projectionName 投影方式名
 */
export function projectArrayCoordinates(coordinates: Array<number>, projection: any): any;
/**
 * 反投影坐标递归函数
 * @internal
 * @param {Array<number>} coordinates 原始坐标数组
...
export function coordToLineString(coordinates: any, properties: any, options?: {}): {
    type: string;
};
/**
...
export function isLngLatArrValid(lnglat: any): boolean;
