...
declare class MetadataTable {
     ...
     *
     * @private
     * @experimental This feature is using part of the 3D Tiles spec
     * that is not final and is subject to change without Cesium's standard deprecation policy.
     */
    private constructor();
    _count: number;
     ...
     * or <code>undefined</code> if the property values are not stored in a typed array.
     *
     * @private
     */
