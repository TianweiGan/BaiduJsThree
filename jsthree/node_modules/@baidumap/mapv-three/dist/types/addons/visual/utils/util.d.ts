export class Utils {
     ...
     * @param {Function} callback 回调函数
     */
    static getInstancedModelByUrl(path: string, count?: number, isDynamic?: number, callback?: Function): void;
     ...
     * @returns {Object} 窗口坐标
     */
    static getWorldPositionByMouse(mouse: Object, camera: Object, viewer: any, _isRealPosition_?: boolean): Object;
    /**
