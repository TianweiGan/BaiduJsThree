...
export class TrafficLightElement extends AbstractElement {
    ...
    createMeshFromGeometry(geometry: any, elementObject: any): TrafficLight;
    /** @internal */
...
import { TrafficLight } from '../../../threejs/objects/element/TrafficLight';
