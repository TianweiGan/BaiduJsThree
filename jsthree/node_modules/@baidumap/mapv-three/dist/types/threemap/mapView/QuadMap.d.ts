...
export class QuadMap {
    ...
    /** @internal */ _delayUpdateTimeHandler: null;
    /**
     * @internal
     ...
     * 调试瓦片加载器
     */
    _debugTileLoader: null;
    /**
     * @internal
     * 用于保存瓦片加载器，当进行瓦片加载器切换时，不用重新实例化一个瓦片加载器
     */
    _savedTileLoader: null;
    /**
     * @internal
     * 瓦片是否分层
     */
    ...
    */
    ...
    _baseZoomInfo: any;
    _gridInstanceMesh: GeoInstancedMesh | undefined;
    ...
    _logLoadInCurrentFrame: boolean | undefined;
    /**
     *
     * @param {*} camera
     ...
     */
    _intersectHeightRange: (box: Box2) => number[];
    /**
     * @private
     * 重置渲染瓦片时统计的数据
     */
    ...
    _isAncestorTile: (currentTile: any, ancestorTile: any) => boolean;
    ...
    _hideChildrenTiles: (renderedTiles: any, tile: any) => any;
    /**
     * @private
    ...
    dispose(): void;
    /**
     * quadmap的材质管理器，可以利用它来设置quadmap的不同材质，如真实材质
     */
    ...
    set showDebugGrid(value: boolean);
    /**
